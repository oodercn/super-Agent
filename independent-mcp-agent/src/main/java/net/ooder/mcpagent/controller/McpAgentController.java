...
public class McpAgentController {
    ...
    public Map<String, Object> healthCheck() {
        ...
        // 添加系统状态信息
        try {
            Map<String, Object> systemStatus = mcpAgentManager.getSystemStatus();
    ...
    public Map<String, Object> getNetworkStatus() {
        ...
        try {
            if (mcpAgentSkill instanceof McpAgentSkillImpl) {
                ...
                log.warn("McpAgentSkill is not an instance of McpAgentSkillImpl");
    ...
    public Map<String, Object> testCommand(@RequestBody Map<String, Object> request) {
        ...
        try {
            ...
            switch (commandType) {
                case "MCP_REGISTER":
                    mcpAgentSkill.handleMcpRegisterCommand(null);
                    break;
                case "MCP_DEREGISTER":
                    mcpAgentSkill.handleMcpDeregisterCommand(null);
                    break;
                case "MCP_HEARTBEAT":
                    mcpAgentSkill.handleMcpHeartbeatCommand(null);
                    break;
                case "MCP_STATUS":
                    mcpAgentSkill.handleMcpStatusCommand(null);
                    break;
                case "MCP_DISCOVER":
                    mcpAgentSkill.handleMcpDiscoverCommand(null);
                    break;
                case "ROUTE_QUERY":
                    mcpAgentSkill.handleRouteQueryCommand(null);
                    break;
                case "ROUTE_UPDATE":
                    mcpAgentSkill.handleRouteUpdateCommand(null);
                    break;
                case "ENDAGENT_DISCOVER":
                    mcpAgentSkill.handleEndagentDiscoverCommand(null);
                    break;
                case "ENDAGENT_STATUS":
                    mcpAgentSkill.handleEndagentStatusCommand(null);
                    break;
                case "ENDAGENT_ADD":
                    mcpAgentSkill.handleEndagentAddCommand(null);
                    break;
                case "ENDAGENT_REMOVE":
                    mcpAgentSkill.handleEndagentRemoveCommand(null);
                    break;
                case "TASK_REQUEST":
                    mcpAgentSkill.handleTaskRequestCommand(null);
                    break;
                case "TASK_RESPONSE":
                    mcpAgentSkill.handleTaskResponseCommand(null);
                    break;
                case "AUTHENTICATE":
                    mcpAgentSkill.handleAuthenticateCommand(null);
                    break;
                case "AUTH_RESPONSE":
                    mcpAgentSkill.handleAuthResponseCommand(null);
                    break;
                default:
