...
class DashboardControllerWebTest {
    ...
    void testGetDashboardStats() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/api/dashboard/stats")
    ...
    void testGetExecutionStats() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/api/dashboard/execution-stats")
                .contentType(MediaType.APPLICATION_JSON));
    ...
    void testGetMarketStats() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/api/dashboard/market-stats")
                .contentType(MediaType.APPLICATION_JSON));
    ...
    void testGetSystemStats() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/api/dashboard/system-stats")
                .contentType(MediaType.APPLICATION_JSON));
