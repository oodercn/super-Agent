...
export const SceneModeMixin = {
    ...
    async acceptTodo(todoId) {
        try {
            const response = await fetch(`/api/v1/scene-groups/${this.sceneGroupId}/todos/${todoId}/accept`, {
                method: 'POST'
            });
            const result = await response.json();
    ...
    async rejectTodo(todoId, reason) {
        try {
            const response = await fetch(`/api/v1/scene-groups/${this.sceneGroupId}/todos/${todoId}/reject`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    async delegateTodo(todoId, toUserId) {
        try {
            const response = await fetch(`/api/v1/scene-groups/${this.sceneGroupId}/todos/${todoId}/delegate`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
