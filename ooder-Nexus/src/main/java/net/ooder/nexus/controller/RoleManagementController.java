...
import net.ooder.nexus.dto.menu.MenuItemDTO;
import net.ooder.nexus.dto.role.RoleDTO;
import net.ooder.nexus.service.MenuRoleConfigService;
...
public class RoleManagementController {
    ...
    private RoleDTO convertToRoleDTO(net.ooder.nexus.dto.menu.MenuConfigDTO.MenuRoleDTO dto) {
