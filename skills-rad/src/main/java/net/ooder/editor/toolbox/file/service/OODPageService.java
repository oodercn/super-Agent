...
import net.ooder.editor.console.java.page.JavaPageTree;
...
@Controller
@RequestMapping("/rad/file/page/")
public class OODPageService {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "JavaPageTree")
    ...
    @APIEventAnnotation(bindTreeEvent = CustomTreeEvent.TREENODEDBCLICK)
    @ResponseBody
    public TreeListResultModel<List<JavaPageTree>> loadJavaPageTree(String projectName, String domainId, String currentClassName) {
        ...
        try {
            ...
            resultModel = TreePageUtil.getTreeList(Arrays.asList(euModule), JavaPageTree.class);
