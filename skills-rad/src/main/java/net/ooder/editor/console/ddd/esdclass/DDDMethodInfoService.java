...
public class DDDMethodInfoService extends BaseViewService {


    @MethodChinaName(cname = "方法聚合")
    @RequestMapping(method = RequestMethod.POST, value = "DDDAPIMethodInfo")
    @TabsViewAnnotation
    ...
    @ResponseBody
    public ResultModel<DDDAPIMethodInfo> getDDDAPIMethodInfo(String projectName, String domainId, String sourceClassName, String sourceMethodName, String currentClassName, String xpath) {
