// Ресурсы интернационализации компонентов UI
(ood.Locale.ru||(ood.Locale.ru={})).UI = {
    // Компонент CheckBox
    checkbox: {
        default: "Флажок"
    },
    ...
    audio: {
        player: "Аудиоплеер",
        controls: "Элементы управления аудио",
        player: {
            muted: "Аудиоплеер (без звука)"
        }
    },
    ...
    video: {
        player: "Видеоплеер",
        controls: "Элементы управления видео",
        player: {
            muted: "Видеоплеер (без звука)"
        },
        poster: "Изображение постера видео",
        canvas: "Видео холст"
    },
    ...
    treeview: {
        node: "Узел дерева",
        toggle: "Развернуть/свернуть узел"
    },
...
(ood.Locale.ru||(ood.Locale.ru={})).UI = {
    ...
    timepicker: {
        label: "Выбор времени",
        toolbar: "Панель навигации по времени",
        selection: "Область выбора времени",
        button: "Кнопка",
        ...
        close: "Закрыть",
        timeInput: "Ввод времени",
        hourInput: "Ввод часов",
        minuteInput: "Ввод минут",
        hour: "Час",
        minute: "Минута"
    },
    ...
    toolbar: {
        ...
        button: "Кнопка инструмента",
        group: "Группа инструментов"
    },
    
    // Компонент Dialog
    dialog: {
        minimize: "Свернуть диалог",
        maximize: "Развернуть диалог",
        close: "Закрыть диалог",
        showInfo: "Показать информацию",
        showOptions: "Показать опции",
        refresh: "Обновить содержимое",
        pin: "Закрепить диалог",
        move: "Переместить диалог"
    },
    ...
    panel: {
        ...
        pop: "Выдвинуть панель",
        refresh: "Обновить содержимое",
        toggle: "Развернуть/Свернуть панель"
    },
    
    // Компонент DatePicker
    datepicker: {
        label: "Выбор даты",
        toolbar: "Панель навигации по датам",
    ...
    colorpicker: {
        label: "Выбор цвета",
        toolbar: "Панель выбора цвета",
        selection: "Область выбора цвета",
        colorInput: "Ввод значения цвета",
        redValue: "Значение красного",
        greenValue: "Значение зеленого",
        blueValue: "Значение синего",
        hueValue: "Значение оттенка",
    ...
    slider: {
        ...
        rangeStart: "Начальное значение диапазона",
        rangeEnd: "Конечное значение диапазона"
    },
...
(ood.Locale.ru||(ood.Locale.ru={})).inline={
    $_$:1,
    ok:'Принять',
    cancel:'Отменить',
    set:'установить',
...
ood.Locale.ru.date={
    ...
    MDHN:function(n,a,b,c,d){return b+ 'день ' + ood.getRes('date.MONTHS.'+a) + " " + (c.length==1?'0':'')+c + ":" + (d.length==1?'0':'')+d},
