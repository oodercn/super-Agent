/**
 * 最终版通知公告组件
 * 完全遵循 OOD 框架的标准动作定义方式
 */
ood.Class("ood.Mobile.OA.NoticeDesignerFinal", 'ood.Module',{
    Instance:{
        initialize : function(){
            // 组件初始化
            ...
            bindDataSource: function(dataSource) {
                ...
                if (dataSource && dataSource.url) {
                    ...
                    if (dataSource.params) {
                        apiCaller.setQueryData(dataSource.params);
                    }
    ...
    Static:{
        Templates: {
            tagName: 'div',
            className: 'ood-mobile-notice-final',
            style: '{_style}',
