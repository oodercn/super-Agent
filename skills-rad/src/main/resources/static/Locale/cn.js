...
(function () {
    ...
    about: {
        description: "联合推出的云原生代码工具",
        action1: "动作 1",
        contact: "联系方式：18618287247",
        wechat: "微信：wenzhanglwz"
    },
    img: {
...
(function () {
    ood.set(ood.Locale, ["doc", "propname"], {
        'ood_absObj': {
            tag: '附加值',
            tagVar: '附加对象',
            dataBinder: '数据绑定器',
...
(function (){
        ood.set(ood.Locale, ["cn", "UI"],{
    video: {
        player: "视频播放器",
        controls: "视频控制",
        player_muted: "静音视频播放器",
        poster: "视频海报",
        canvas: "视频画布"
    },
    treeview: {
    ...
    editor: {
        fontsizeList: "小;中;大;特大",
        fontnameList: "宋体;黑体;楷体;微软雅黑",
        formatblockList: "段落;标题1;标题2;标题3"
    },
    panel: {
        showInfo: "显示信息",
        showOptions: "显示选项",
...
(function (){
  ood.set(ood.Locale, ["cn", "DataModel"],{
