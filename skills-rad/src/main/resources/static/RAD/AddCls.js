ood.Class('RAD.AddCls', 'ood.Module', {
    Instance: {
        _serial: 1,
        ajax: {},
        ...
        _apply: function () {
            var ns = this,
                className=ns.inputTarget.getUIValue();
                ...
                ns.ajax.invoke(
                    function (txt) {
                        ...
                        if (obj && obj.requestStatus != -1) {
                            ns.dialog.close();
                            ns.fireEvent('onOK', [obj.data, "class"]);
