ood.Class('RAD.ProjectSelector', 'ood.Module',{
    Instance:{
        ...
        _refreshContent:function(){
            ...
            ood.Ajax(CONF.getProjectListService,  {path:CONF.wsPath,pattern:ns._filter},
                function(txt){
                    ns.dialog.free();
                    var obj = txt;
                    if(!obj || obj.error)
                        ...
                        if(obj && obj.length){
                            ood.arr.each(obj,function(i){
                               // if(i.type===0){
                                    ns.properties.projectList.push({id:i.location,name:i.name,caption:i.name});
                                //}
                            });
                        }
