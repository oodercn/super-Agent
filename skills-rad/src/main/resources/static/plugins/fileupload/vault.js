        ...
        request.onloadend = function () {
            ...
            for (var _i = 0, fileWrappers_3 = fileWrappers; _i < fileWrappers_3.length; _i++) {
                ...
                if (status === types_1.FileStatus.uploaded) {
                    ...
                    var data={
                        eventType:types_1.UploaderEvents.uploadFile,
                    ...
                    var data={
                        eventType:types_1.UploaderEvents.uploadFail,
                        item:fileWrapper.file,
                        response:request.response
                    }
                    try {
            ...
            if (_this._uploadInfo.count === 0) {
                ...
                var data={
                    eventType:types_1.UploaderEvents.uploadComplete,
