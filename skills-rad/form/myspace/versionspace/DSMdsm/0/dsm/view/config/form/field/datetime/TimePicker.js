// 自动生成的 TimePicker 组件
ood.Class("ooder.TimePicker", "ood.Module", {
    Instance: {
        // 初始化方法
        initialize: function() {
            this.iniComponents();
        ...
        iniComponents: function() {
            ...
            // TimePickerMain
            var TimePickerMain = ood.create("ood.UI.Block")
                .setHost(host, "TimePickerMain")
                .setName("TimePickerMain")
                .setDock("fill")
                .setPanelBgClr("transparent")
                .setTabindex(1)
            ;
            append(TimePickerMain);
            ...
            var SAVE = ood.create("ood.APICaller")
                ...
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/form/field/combo/time/updateDatePicker")
                .setRequestDataSource([{"name":"comboView","path":"","type":"FORM"},{"name":"projectName","path":"","type":"FORM"},{"name":"domainId","path":"","type":"FORM"},{"name":"comboView","path":"","type":"FORM"},{"name":"projectName","path":"","type":"FORM"},{"name":"domainId","path":"","type":"FORM"},{"name":"TimePickerMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("JSON")
                .setResponseCallback([])
                .setResponseDataTarget([])
                .setResponseType("JSON")
                .setSourceClassName("net.ooder.dsm.view.config.form.field.combo.service.ComboTimeService")
                .setTabindex(2)
                .setTips("保存")
            ;
            append(SAVE);
            ...
            var RESET = ood.create("ood.APICaller")
                ...
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/form/field/combo/time/reSetDatePicker")
                .setRequestDataSource([{"name":"comboView","path":"","type":"FORM"},{"name":"projectName","path":"","type":"FORM"},{"name":"domainId","path":"","type":"FORM"},{"name":"comboView","path":"","type":"FORM"},{"name":"projectName","path":"","type":"FORM"},{"name":"domainId","path":"","type":"FORM"},{"name":"TimePickerMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("JSON")
                .setResponseCallback([])
                .setResponseDataTarget([])
            ...
            var RELOAD = ood.create("ood.APICaller")
                ...
                .setIsAllform(false)
                .setMethodName("getTimePicker")
                .setProxyType("auto")
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/form/field/datetime/TimePicker")
                .setRequestDataSource([{"name":"TimePickerMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
                .setResponseDataTarget([{"name":"TimePickerMain","path":"data","type":"FORM"},{"name":"PAGECTX","path":"data","type":"FORM"}])
                .setResponseType("JSON")
            ...
            // TimePicker
            var TimePicker = ood.create("ood.UI.FormLayout")
                .setHost(TimePickerMain, "TimePicker")
                .setName("TimePicker")
                .setCaption("日期选择框")
                ...
                .setImageClass("ri-calendar-line")
                .setLayoutData({"cells":{"A1":{"cellName":"A1","style":{"textAlign":"center"},"value":"字段名"},"A2":{"cellName":"A2","style":{"textAlign":"center"},"value":"宽度"},"A3":{"cellName":"A3","style":{"textAlign":"center"},"value":"关闭按钮"},"C1":{"cellName":"C1","style":{"textAlign":"center"},"value":"高度"},"C2":{"cellName":"C2","style":{"textAlign":"center"},"value":"默认值"}},"colSetting":{"A":{"manualWidth":150},"B":{"manualWidth":150},"C":{"manualWidth":150},"D":{"manualWidth":150}},"cols":4,"rowSetting":{"1":{"manualHeight":35},"2":{"manualHeight":35},"3":{"manualHeight":35}},"rows":3})
                .setLineSpacing(10)
                .setMode("write")
            ...
            ;
            TimePickerMain.append(TimePicker);

            // fieldname
            var fieldname = ood.create("ood.UI.Input")
                .setHost(TimePicker, "fieldname")
                .setName("fieldname")
                .setCaption("字段名")
                .setDefaultFocus(false)
                .setDesc("字段名")
                ...
                .setVisibility("visible")
            ;
            TimePicker.append(fieldname);

            // height
            var height = ood.create("ood.UI.Input")
                .setHost(TimePicker, "height")
                .setName("height")
                .setCaption("高度")
                .setDefaultFocus(false)
                .setDesc("高度")
                ...
                .setVisibility("visible")
            ;
            TimePicker.append(height);

            // width
            var width = ood.create("ood.UI.Input")
                .setHost(TimePicker, "width")
                .setName("width")
                .setCaption("宽度")
                .setDefaultFocus(false)
                .setDesc("宽度")
                ...
                .setVisibility("visible")
            ;
            TimePicker.append(width);

            // value
            var value = ood.create("ood.UI.Input")
                .setHost(TimePicker, "value")
                .setName("value")
                .setCaption("默认值")
                .setDefaultFocus(false)
                .setDesc("默认值")
                ...
                .setVisibility("visible")
            ;
            TimePicker.append(value);

            // closeBtn
            var closeBtn = ood.create("ood.UI.CheckBox")
                .setHost(TimePicker, "closeBtn")
                .setName("closeBtn")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("关闭按钮")
                ...
                .setVisibility("visible")
            ;
            TimePicker.append(closeBtn);

            // SAVEBottomBlock
            var SAVEBottomBlock = ood.create("ood.UI.Block")
                .setHost(TimePickerMain, "SAVEBottomBlock")
                ...
                .setTabindex(1)
            ;
            TimePickerMain.append(SAVEBottomBlock);
