// 自动生成的 CellMenuTree 组件
ood.Class("ooder.CellMenuTree", "ood.Module", {
    Instance: {
        // 初始化方法
        initialize: function() {
            this.iniComponents();
        ...
        "bindClass": [],
        "caption": "导入菜单动作",
        "currComponentAlias": "CellMenuTree",
        "dock": "fill",
        "title": "导入菜单动作"
},
                ...
                "actions": [
                        {
                                "args": [
                                        ...
                                        null,
                                        null,
                                        "{page.CellMenuTree.getCallBackValue()}"
                                ],
                                "conditions": [
                                        {
                                                "symbol": "!=",
                                                "left": "{page.CellMenuTreegetCaptionValue()}",
                                                "right": "{}"
                                        }
                                ],
                                "desc": "填充返回值",
        ...
        iniComponents: function() {
            ...
            // CellMenuTreeMain
            var CellMenuTreeMain = ood.create("ood.UI.Dialog")
                .setHost(host, "CellMenuTreeMain")
                .setName("CellMenuTreeMain")
                .setCaption("导入菜单动作")
            ...
            var RELOAD = ood.create("ood.APICaller")
                ...
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/grid/cell/contextmenu/CellMenuTree")
                .setRequestDataSource([{"name":"PAGECTX","path":"","type":"FORM"},{"name":"CellMenuTreeMain","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
                .setResponseDataTarget([{"name":"CellMenuTree","path":"data","type":"TREEVIEW"},{"name":"PAGECTX","path":"data","type":"FORM"}])
            ...
            var SAVE = ood.create("ood.APICaller")
                ...
                .setRequestDataSource([{"name":"CellMenuTree","path":"","type":"FORM"},{"name":"CellMenuTreeMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
            ...
            // CellMenuTree
            var CellMenuTree = ood.create("ood.UI.TreeView")
                .setHost(CellMenuTreeMain, "CellMenuTree")
                .setName("CellMenuTree")
                .setCaption("AllCellContextMenuTree")
                .setDefaultFocus(false)
                .setDisableClickEffect(false)
                .setDisableHoverEffect(false)
                .setDisableTips(false)
            ...
            var StatusBottomBlock = ood.create("ood.UI.Block")
                ...
                .setTabindex(1)
            ;
            CellMenuTreeMain.append(StatusBottomBlock);
