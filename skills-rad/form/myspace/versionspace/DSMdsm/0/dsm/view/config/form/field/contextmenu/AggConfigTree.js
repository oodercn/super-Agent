    ...
    Instance: {
        ...
        iniComponents: function() {
            ...
            var RELOAD = ood.create("ood.APICaller")
                ...
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/form/field/contextmenu/AggConfigTree")
