// 自动生成的 BaseGalleryMenuTree 组件
ood.Class("ooder.BaseGalleryMenuTree", "ood.Module", {
    Instance: {
        // 初始化方法
        initialize: function() {
            this.iniComponents();
        ...
        "bindClass": [],
        "caption": "导入菜单动作",
        "currComponentAlias": "BaseGalleryMenuTree",
        "dock": "fill",
        "title": "导入菜单动作"
},
                ...
                "actions": [
                        {
                                "args": [
                                        ...
                                        null,
                                        null,
                                        "{page.BaseGalleryMenuTree.getCallBackValue()}"
                                ],
                                "conditions": [
                                        {
                                                "symbol": "!=",
                                                "left": "{page.BaseGalleryMenuTreegetCaptionValue()}",
                                                "right": "{}"
                                        }
                                ],
                                "desc": "填充返回值",
        ...
        iniComponents: function() {
            ...
            // BaseGalleryMenuTreeMain
            var BaseGalleryMenuTreeMain = ood.create("ood.UI.Dialog")
                .setHost(host, "BaseGalleryMenuTreeMain")
                .setName("BaseGalleryMenuTreeMain")
                .setCaption("导入菜单动作")
                ...
                .setWidth("400.0")
            ;
            append(BaseGalleryMenuTreeMain);
            ...
            var RELOAD = ood.create("ood.APICaller")
                ...
                .setIsAllform(true)
                .setMethodName("getCellMenuTree")
                .setProxyType("auto")
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/base/gallery/item/BaseGalleryMenuTree")
                .setRequestDataSource([{"name":"PAGECTX","path":"","type":"FORM"},{"name":"BaseGalleryMenuTreeMain","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
                .setResponseDataTarget([{"name":"BaseGalleryMenuTree","path":"data","type":"TREEVIEW"},{"name":"PAGECTX","path":"data","type":"FORM"}])
            ...
            var SAVE = ood.create("ood.APICaller")
                ...
                .setRequestDataSource([{"name":"BaseGalleryMenuTree","path":"","type":"FORM"},{"name":"BaseGalleryMenuTreeMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
            ...
            // BaseGalleryMenuTree
            var BaseGalleryMenuTree = ood.create("ood.UI.TreeView")
                .setHost(BaseGalleryMenuTreeMain, "BaseGalleryMenuTree")
                .setName("BaseGalleryMenuTree")
                .setCaption("BaseGalleryContextMenuTree")
                .setDefaultFocus(false)
                .setDisableClickEffect(false)
                .setDisableHoverEffect(false)
                .setDisableTips(false)
            ...
            var StatusBottomBlock = ood.create("ood.UI.Block")
                ...
                .setTabindex(1)
            ;
            BaseGalleryMenuTreeMain.append(StatusBottomBlock);
