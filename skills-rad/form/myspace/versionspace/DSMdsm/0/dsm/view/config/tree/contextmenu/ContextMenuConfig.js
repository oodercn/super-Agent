// 自动生成的 ContextMenuConfig 组件
ood.Class("ooder.ContextMenuConfig", "ood.Module", {
    Instance: {
        // 初始化方法
        initialize: function() {
            this.iniComponents();
        ...
        "bindClass": [],
        "caption": "右键菜单操作按钮",
        "currComponentAlias": "ContextMenuConfig",
        "dock": "fill",
        "title": "右键菜单操作按钮"
},
        ...
        iniComponents: function() {
            ...
            // ContextMenuConfigMain
            var ContextMenuConfigMain = ood.create("ood.UI.Block")
                .setHost(host, "ContextMenuConfigMain")
                .setName("ContextMenuConfigMain")
                .setDock("fill")
                .setPanelBgClr("transparent")
                .setTabindex(1)
            ;
            append(ContextMenuConfigMain);
            ...
            var SAVE = ood.create("ood.APICaller")
                ...
                .setIsAllform(true)
                .setMethodName("saveContextMenu")
                .setProxyType("auto")
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/tree/contextmenu/saveContextMenu")
                .setRequestDataSource([{"name":"ContextMenuConfigMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
                .setResponseDataTarget([])
                .setResponseType("JSON")
                .setSourceClassName("net.ooder.dsm.view.config.tree.contextmenu.menuclass.ContextTreeMenuService")
                .setTabindex(2)
                .setTips("保存")
            ;
            append(SAVE);
            ...
            var RELOAD = ood.create("ood.APICaller")
                ...
                .setImageClass("ri-code-box-line")
                .setIsAllform(false)
                .setMethodName("getContextMenuConfig")
                .setProxyType("auto")
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/tree/contextmenu/ContextMenuConfig")
                .setRequestDataSource([{"name":"ContextMenuConfigMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
                .setResponseDataTarget([{"name":"ContextMenuConfigMain","path":"data","type":"FORM"},{"name":"PAGECTX","path":"data","type":"FORM"}])
                .setResponseType("JSON")
                .setSourceClassName("net.ooder.dsm.view.config.tree.contextmenu.ContextTreeMenuNav")
                .setTabindex(3)
                .setTips("右键菜单操作按钮")
            ;
            append(RELOAD);
            ...
            // ContextMenuConfig
            var ContextMenuConfig = ood.create("ood.UI.FormLayout")
                .setHost(ContextMenuConfigMain, "ContextMenuConfig")
                .setName("ContextMenuConfig")
                .setCaption("右键菜单操作按钮")
            ...
            ;
            ContextMenuConfigMain.append(ContextMenuConfig);

            // handler
            var handler = ood.create("ood.UI.CheckBox")
                .setHost(ContextMenuConfig, "handler")
                .setName("handler")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("行头手柄")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(handler);

            // dynLoad
            var dynLoad = ood.create("ood.UI.CheckBox")
                .setHost(ContextMenuConfig, "dynLoad")
                .setName("dynLoad")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("动态加载")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(dynLoad);

            // lazy
            var lazy = ood.create("ood.UI.CheckBox")
                .setHost(ContextMenuConfig, "lazy")
                .setName("lazy")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("延迟加载")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(lazy);

            // serviceClass
            var serviceClass = ood.create("ood.UI.Input")
                .setHost(ContextMenuConfig, "serviceClass")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(serviceClass);

            // hideAfterClick
            var hideAfterClick = ood.create("ood.UI.CheckBox")
                .setHost(ContextMenuConfig, "hideAfterClick")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(hideAfterClick);

            // listKey
            var listKey = ood.create("ood.UI.Input")
                .setHost(ContextMenuConfig, "listKey")
                .setName("listKey")
                .setCaption("拖动支持KEY")
                .setDefaultFocus(false)
                .setDesc("拖动支持KEY")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(listKey);

            // autoHide
            var autoHide = ood.create("ood.UI.CheckBox")
                .setHost(ContextMenuConfig, "autoHide")
                .setName("autoHide")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("自动隐藏")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(autoHide);

            // parentID
            var parentID = ood.create("ood.UI.Input")
                .setHost(ContextMenuConfig, "parentID")
                .setName("parentID")
                .setCaption("父级ID")
                .setDefaultFocus(false)
                .setDesc("父级ID")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(parentID);

            // formField
            var formField = ood.create("ood.UI.CheckBox")
                .setHost(ContextMenuConfig, "formField")
                .setName("formField")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("是否数据域")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(formField);

            // iconFontSize
            var iconFontSize = ood.create("ood.UI.Input")
                .setHost(ContextMenuConfig, "iconFontSize")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(iconFontSize);

            // itemClass
            var itemClass = ood.create("ood.UI.Input")
                .setHost(ContextMenuConfig, "itemClass")
                .setName("itemClass")
                .setCaption("菜单项Class")
                .setDefaultFocus(false)
                .setDesc("菜单项Class")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(itemClass);

            // itemStyle
            var itemStyle = ood.create("ood.UI.Input")
                .setHost(ContextMenuConfig, "itemStyle")
                .setName("itemStyle")
                .setCaption("菜单项Style")
                .setDefaultFocus(false)
                .setDesc("菜单项Style")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(itemStyle);

            // bindService
            var bindService = ood.create("ood.UI.ComboInput")
                .setHost(ContextMenuConfig, "bindService")
                .setName("bindService")
                .setCaption("绑定服务")
                .setDefaultFocus(false)
                .setDesc("绑定服务")
                ...
                .setVisibility("visible")
            ;
            ContextMenuConfig.append(bindService);
