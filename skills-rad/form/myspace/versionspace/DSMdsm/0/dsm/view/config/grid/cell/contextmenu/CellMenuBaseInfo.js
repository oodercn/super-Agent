// 自动生成的 CellMenuBaseInfo 组件
ood.Class("ooder.CellMenuBaseInfo", "ood.Module", {
    Instance: {
        // 初始化方法
        initialize: function() {
            this.iniComponents();
        ...
        "bindClass": [],
        "caption": "单元格菜单信息",
        "currComponentAlias": "CellMenuBaseInfo",
        "dock": "fill",
        "title": "单元格菜单信息"
},
        ...
        iniComponents: function() {
            ...
            // CellMenuBaseInfoMain
            var CellMenuBaseInfoMain = ood.create("ood.UI.Block")
                .setHost(host, "CellMenuBaseInfoMain")
                .setName("CellMenuBaseInfoMain")
                .setDock("fill")
                .setPanelBgClr("transparent")
                .setTabindex(1)
            ;
            append(CellMenuBaseInfoMain);
            ...
            var SAVE = ood.create("ood.APICaller")
                ...
                .setRequestDataSource([{"name":"CellMenuBaseInfoMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
            ...
            var RELOAD = ood.create("ood.APICaller")
                ...
                .setImageClass("ri-code-box-line")
                .setIsAllform(false)
                .setMethodName("CellMenuBaseInfo")
                .setProxyType("auto")
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/grid/cell/contextmenu/CellMenuBaseInfo")
                .setRequestDataSource([{"name":"CellMenuBaseInfoMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
                .setResponseDataTarget([{"name":"CellMenuBaseInfoMain","path":"data","type":"FORM"},{"name":"PAGECTX","path":"data","type":"FORM"}])
                .setResponseType("JSON")
            ...
            // CellMenuBaseInfo
            var CellMenuBaseInfo = ood.create("ood.UI.FormLayout")
                .setHost(CellMenuBaseInfoMain, "CellMenuBaseInfo")
                .setName("CellMenuBaseInfo")
                .setCaption("单元格菜单信息")
            ...
            ;
            CellMenuBaseInfoMain.append(CellMenuBaseInfo);

            // handler
            var handler = ood.create("ood.UI.CheckBox")
                .setHost(CellMenuBaseInfo, "handler")
                .setName("handler")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("行头手柄")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(handler);

            // dynLoad
            var dynLoad = ood.create("ood.UI.CheckBox")
                .setHost(CellMenuBaseInfo, "dynLoad")
                .setName("dynLoad")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("动态加载")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(dynLoad);

            // lazy
            var lazy = ood.create("ood.UI.CheckBox")
                .setHost(CellMenuBaseInfo, "lazy")
                .setName("lazy")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("延迟加载")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(lazy);

            // serviceClass
            var serviceClass = ood.create("ood.UI.Input")
                .setHost(CellMenuBaseInfo, "serviceClass")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(serviceClass);

            // hideAfterClick
            var hideAfterClick = ood.create("ood.UI.CheckBox")
                .setHost(CellMenuBaseInfo, "hideAfterClick")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(hideAfterClick);

            // listKey
            var listKey = ood.create("ood.UI.Input")
                .setHost(CellMenuBaseInfo, "listKey")
                .setName("listKey")
                .setCaption("拖动支持KEY")
                .setDefaultFocus(false)
                .setDesc("拖动支持KEY")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(listKey);

            // autoHide
            var autoHide = ood.create("ood.UI.CheckBox")
                .setHost(CellMenuBaseInfo, "autoHide")
                .setName("autoHide")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("自动隐藏")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(autoHide);

            // parentID
            var parentID = ood.create("ood.UI.Input")
                .setHost(CellMenuBaseInfo, "parentID")
                .setName("parentID")
                .setCaption("父级ID")
                .setDefaultFocus(false)
                .setDesc("父级ID")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(parentID);

            // formField
            var formField = ood.create("ood.UI.CheckBox")
                .setHost(CellMenuBaseInfo, "formField")
                .setName("formField")
                .setCaption("")
                .setDefaultFocus(false)
                .setDesc("是否数据域")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(formField);

            // iconFontSize
            var iconFontSize = ood.create("ood.UI.Input")
                .setHost(CellMenuBaseInfo, "iconFontSize")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(iconFontSize);

            // itemClass
            var itemClass = ood.create("ood.UI.Input")
                .setHost(CellMenuBaseInfo, "itemClass")
                .setName("itemClass")
                .setCaption("菜单项Class")
                .setDefaultFocus(false)
                .setDesc("菜单项Class")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(itemClass);

            // itemStyle
            var itemStyle = ood.create("ood.UI.Input")
                .setHost(CellMenuBaseInfo, "itemStyle")
                .setName("itemStyle")
                .setCaption("菜单项Style")
                .setDefaultFocus(false)
                .setDesc("菜单项Style")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(itemStyle);

            // bindService
            var bindService = ood.create("ood.UI.ComboInput")
                .setHost(CellMenuBaseInfo, "bindService")
                .setName("bindService")
                .setCaption("绑定服务")
                .setDefaultFocus(false)
                .setDesc("绑定服务")
                ...
                .setVisibility("visible")
            ;
            CellMenuBaseInfo.append(bindService);
