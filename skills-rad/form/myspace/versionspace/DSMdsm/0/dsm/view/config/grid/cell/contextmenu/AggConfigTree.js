    ...
    Instance: {
        ...
        iniComponents: function() {
            ...
            var RELOAD = ood.create("ood.APICaller")
                ...
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/grid/cell/contextmenu/AggConfigTree")
            ...
            var SAVE = ood.create("ood.APICaller")
                ...
                .setIsAllform(true)
                .setMethodName("saveCellMenuClass")
                .setProxyType("auto")
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/view/config/grid/cell/contextmenu/saveCellMenuClass")
            ...
            var AggMenuConfigTree = ood.create("ood.UI.TreeView")
                ...
                .setFormField(true)
                .setInitFold(false)
                .setItems([{"bindClass":["java.lang.Void"],"caption":"AggMenuConfigTree","id":"aggConfigTree","imageClass":"ri-settings-3-line","initFold":false,"sub":[{"bindClass":["net.ooder.dsm.aggregation.config.entity.tree.EntityMethodService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.tree.EntityMethodService","caption":"菜单配置（null)","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.menu.tree.MenuItemViewBean","groupName":"dsm_agg_entity_config_LoadNav","id":"dsm_agg_entity_config_LoadNav","imageClass":"ri-node-tree","initFold":true,"tagVar":{"name":"loadNav"},"title":"菜单配置（null)"},{"bindClass":["net.ooder.dsm.aggregation.config.menu.tree.AggMenuWebService"],"bindClassName":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuWebService","caption":"Web配置","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuNavItem","groupName":"AggMenuNavItem_WebMethodConfig_dsm_agg_menu_config_method_ConfigBaseInfo","id":"WebMethodConfig","imageClass":"spafont spa-icon-c-webapi","initFold":false,"tagVar":{"name":"WebMethodConfig"},"title":"Web配置"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.AggEntityInfoService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.AggEntityInfoService","caption":"菜单配置（null)","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.esd.bean.CustomViewBean","groupName":"dsm_view_entity_AggEntityInfo","id":"dsm_view_entity_AggEntityInfo","imageClass":"ri-node-tree","initFold":true,"tagVar":{"name":"aggEntityInfo"},"title":"菜单配置（null)"},{"bindClass":["net.ooder.dsm.aggregation.config.menu.tree.AggMenuMethodsNavService"],"bindClassName":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuMethodsNavService","caption":"菜单项配置","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuMainNavItem","groupName":"AggMenuMainNavItem_MethodConfig_dsm_agg_menu_config_LoadAllMethod","id":"MethodConfig","imageClass":"ri-settings-line","initFold":false,"tagVar":{"name":"MethodConfig"},"title":"菜单项配置"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.tree.AggEntityTreeNavService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityTreeNavService","caption":"菜单配置（null)","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.esd.bean.CustomAPICallBean","groupName":"dsm_agg_entity_config_nav_LoadEntity","id":"dsm_agg_entity_config_nav_LoadEntity","imageClass":"ri-node-tree","tagVar":{"name":"loadEntity"},"title":"菜单配置（null)"},{"bindClass":["net.ooder.dsm.aggregation.config.menu.tree.AggMenuConfigNavService"],"bindClassName":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuConfigNavService","caption":"菜单配置","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuNavItem","groupName":"AggMenuNavItem_MenuMethodConfig_dsm_agg_menu_config_method_group_AggMenuConfigView","id":"MenuMethodConfig","imageClass":"spafont spa-icon-project","initFold":false,"tagVar":{"name":"MenuMethodConfig"},"title":"菜单配置"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.tree.AggEntityViewService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityViewService","caption":"菜单配置（null)","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.menu.tree.MenuItemBean","groupName":"dsm_agg_entity_LoadChildView","id":"dsm_agg_entity_LoadChildView","imageClass":"ri-node-tree","initFold":true,"tagVar":{"name":"loadChildView"},"title":"菜单配置（null)"},{"bindClass":["net.ooder.dsm.aggregation.config.menu.tree.AggMenuMethodNavService"],"bindClassName":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuMethodNavService","caption":"方法调用","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuNavItem","groupName":"AggMenuNavItem_CustomMethodConfig_dsm_agg_menu_config_method_LoadMenuMethod","id":"CustomMethodConfig","imageClass":"ri-settings-line","initFold":true,"tagVar":{"name":"CustomMethodConfig"},"title":"方法调用"},{"bindClass":["net.ooder.dsm.aggregation.config.menu.tree.AggMenuConfigTree"],"bindClassName":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuConfigTree","caption":"AggMenuConfigTree","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.dsm.aggregation.config.menu.tree.AggMenuConfigTree","id":"null","imageClass":"ri-settings-3-line","tagVar":{"name":"aggConfigTree"},"title":"AggMenuConfigTree"},{"bindClass":["java.lang.Void"],"caption":"loadNav","groupName":"dsm_agg_entity_config_LoadNav","id":"loadNav","imageClass":"ri-tree-line","initFold":false,"sub":[{"bindClass":["net.ooder.dsm.aggregation.config.entity.tree.field.AggEntityFieldService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.tree.field.AggEntityFieldService","caption":"loadNav（null)","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.esd.dsm.aggregation.FieldAggConfig","groupName":"dsm_agg_field_FieldInfo","id":"loadNav_dsm_agg_field_FieldInfo","imageClass":"ri-node-tree","tagVar":{"name":"fieldInfo"},"title":"loadNav（null)"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.ref.AggRefService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.ref.AggRefService","caption":"loadNav（null)","closeBtn":false,"dynDestory":true,"dynLoad":false,"entityClass":"net.ooder.esd.dsm.aggregation.ref.AggEntityRef","groupName":"dsm_agg_entity_config_ref_RefInfo","id":"loadNav_dsm_agg_entity_config_ref_RefInfo","imageClass":"ri-node-tree","initFold":true,"tagVar":{"name":"refInfo"},"title":"loadNav（null)"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.AggEntityInfoService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.AggEntityInfoService","caption":"loadNav（null)","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.esd.bean.CustomViewBean","groupName":"dsm_view_entity_AggEntityInfo","id":"loadNav_dsm_view_entity_AggEntityInfo","imageClass":"ri-node-tree","initFold":true,"tagVar":{"name":"aggEntityInfo"},"title":"loadNav（null)"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.tree.EntityMethodService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.tree.EntityMethodService","caption":"loadNav（null)","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.esd.bean.MethodConfig","groupName":"dsm_agg_entity_config_LoadNav","id":"loadNav_dsm_agg_entity_config_LoadNav","imageClass":"ri-node-tree","initFold":true,"tagVar":{"name":"loadNav"},"title":"loadNav（null)"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.tree.EntityMethodService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.tree.EntityMethodService","caption":"控制调用","closeBtn":false,"dynDestory":false,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityMethodNavItem","groupName":"AggEntityMethodNavItem_ViewConfig_dsm_agg_entity_config_LoadNav","id":"loadNav_ViewConfig","imageClass":"spafont spa-icon-c-webapi","initFold":true,"tagVar":{"name":"ViewConfig"},"title":"控制调用"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.AggEntityInfoService","net.ooder.dsm.aggregation.config.entity.tree.AggEntityViewNavService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.AggEntityInfoService","caption":"方法调用","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityNavItem","groupName":"AggEntityNavItem_ViewMethodConfig_dsm_agg_entity_config_view_LoadView","id":"loadNav_ViewMethodConfig","imageClass":"spafont spa-icon-project","initFold":false,"tagVar":{"name":"ViewMethodConfig"},"title":"方法调用"},{"bindClass":["net.ooder.dsm.aggregation.module.event.ModuleEventService"],"bindClassName":"net.ooder.dsm.aggregation.module.event.ModuleEventService","caption":"模块事件","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.dsm.aggregation.module.ModuleEventNavItem","groupName":"ModuleEventNavItem_ModuleEventView_dsm_agg_entity_config_module_ModuleEvents","id":"loadNav_ModuleEventView","imageClass":"spafont spa-icon-event","initFold":false,"tagVar":{"name":"ModuleEventView"},"title":"模块事件"},{"bindClass":["net.ooder.dsm.aggregation.api.method.service.MethodBaseService"],"bindClassName":"net.ooder.dsm.aggregation.api.method.service.MethodBaseService","caption":"接口配置","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.dsm.aggregation.api.method.AggAPINavItem","groupName":"AggAPINavItem_APIConfig_dsm_agg_api_config_APIBaseMethodInfo","id":"loadNav_APIConfig","imageClass":"spafont spa-icon-c-webapi","initFold":true,"tagVar":{"name":"APIConfig"},"title":"接口配置"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.AggEntityInfoService","net.ooder.dsm.aggregation.config.entity.tree.AggEntityMethodNavService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.AggEntityInfoService","caption":"领域事件","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityNavItem","groupName":"AggEntityNavItem_CustomMethodConfig_dsm_agg_entity_config_method_LoadMethod","id":"loadNav_CustomMethodConfig","imageClass":"ri-settings-line","initFold":true,"tagVar":{"name":"CustomMethodConfig"},"title":"领域事件"},{"bindClass":["net.ooder.dsm.aggregation.module.ModuleConfigService"],"bindClassName":"net.ooder.dsm.aggregation.module.ModuleConfigService","caption":"动作事件","closeBtn":false,"dynDestory":false,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityMethodNavItem","groupName":"AggEntityMethodNavItem_ModuleConfig_dsm_agg_module_config_LoadModuleNav","id":"loadNav_ModuleConfig","imageClass":"ri-play-circle-line","initFold":true,"tagVar":{"name":"ModuleConfig"},"title":"动作事件"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.tree.AggEntityViewService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityViewService","caption":"loadNav（null)","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.esd.bean.CustomViewBean","groupName":"dsm_agg_entity_LoadChildView","id":"loadNav_dsm_agg_entity_LoadChildView","imageClass":"ri-node-tree","initFold":true,"tagVar":{"name":"loadChildView"},"title":"loadNav（null)"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.tree.field.AggEntityFieldsService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.tree.field.AggEntityFieldsService","caption":"条目信息","closeBtn":false,"dynDestory":true,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityNavItem","groupName":"AggEntityNavItem_FieldsConfig_dsm_agg_field_LoadFieldList","id":"loadNav_FieldsConfig","imageClass":"spafont spa-icon-c-comboinput","initFold":true,"tagVar":{"name":"FieldsConfig"},"title":"条目信息"},{"bindClass":["net.ooder.dsm.aggregation.module.panel.ModuleWinService","net.ooder.dsm.aggregation.module.ModuleDeisignerService"],"bindClassName":"net.ooder.dsm.aggregation.module.panel.ModuleWinService","caption":"窗体画布","closeBtn":false,"dynDestory":false,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityMethodNavItem","groupName":"AggEntityMethodNavItem_DesignerConfig_dsm_agg_module_config_LoadWinItem","id":"loadNav_DesignerConfig","imageClass":"ri-paint-brush-line","initFold":true,"tagVar":{"name":"DesignerConfig"},"title":"窗体画布"},{"bindClass":["net.ooder.dsm.aggregation.module.action.ModuleActionService"],"bindClassName":"net.ooder.dsm.aggregation.module.action.ModuleActionService","caption":"常用动作","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.dsm.aggregation.module.ModuleEventNavItem","groupName":"ModuleEventNavItem_ModuleActionView_dsm_agg_module_config_actions_ModuleActions","id":"loadNav_ModuleActionView","imageClass":"spafont spa-icon-action","initFold":false,"tagVar":{"name":"ModuleActionView"},"title":"常用动作"},{"bindClass":["net.ooder.dsm.aggregation.api.method.service.MethodEventService"],"bindClassName":"net.ooder.dsm.aggregation.api.method.service.MethodEventService","caption":"监听事件","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.dsm.aggregation.api.method.AggAPINavItem","groupName":"AggAPINavItem_EventConfig_dsm_agg_api_config_events_CustomEvents","id":"loadNav_EventConfig","imageClass":"spafont spa-icon-event","initFold":false,"tagVar":{"name":"EventConfig"},"title":"监听事件"},{"bindClass":["net.ooder.dsm.aggregation.api.method.service.ViewEventService"],"bindClassName":"net.ooder.dsm.aggregation.api.method.service.ViewEventService","caption":"视图绑定事件","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.dsm.aggregation.api.method.AggAPINavItem","groupName":"AggAPINavItem_BindEventConfig_dsm_agg_api_config_events_view_ViewEvents","id":"loadNav_BindEventConfig","imageClass":"spafont spa-icon-c-databinder","initFold":false,"tagVar":{"name":"BindEventConfig"},"title":"视图绑定事件"},{"bindClass":["net.ooder.dsm.aggregation.api.method.service.APIBindMenuService"],"bindClassName":"net.ooder.dsm.aggregation.api.method.service.APIBindMenuService","caption":"关联按钮","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.dsm.aggregation.api.method.AggAPINavItem","groupName":"AggAPINavItem_BindConfig_dsm_agg_api_config_bindmenu_APIBindMenus","id":"loadNav_BindConfig","imageClass":"spafont spa-icon-values","initFold":false,"tagVar":{"name":"BindConfig"},"title":"关联按钮"},{"bindClass":["net.ooder.dsm.aggregation.api.method.service.APIBindActionService"],"bindClassName":"net.ooder.dsm.aggregation.api.method.service.APIBindActionService","caption":"绑定动作","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.dsm.aggregation.api.method.AggAPINavItem","groupName":"AggAPINavItem_BindActionConfig_dsm_agg_api_config_bindactions_BindActions","id":"loadNav_BindActionConfig","imageClass":"spafont spa-icon-values","initFold":false,"tagVar":{"name":"BindActionConfig"},"title":"绑定动作"},{"bindClass":["net.ooder.dsm.aggregation.config.entity.info.AggregationInfoService"],"bindClassName":"net.ooder.dsm.aggregation.config.entity.info.AggregationInfoService","caption":"聚合配置","closeBtn":false,"dynDestory":false,"dynLoad":true,"entityClass":"net.ooder.dsm.aggregation.config.entity.tree.AggEntityMethodNavItem","groupName":"AggEntityMethodNavItem_AggInfo_dsm_manager_agg_entity_AggInfo","id":"loadNav_AggInfo","imageClass":"spafont spa-icon-rendermode","initFold":true,"tagVar":{"name":"AggInfo"},"title":"聚合配置"},{"bindClass":["net.ooder.dsm.aggregation.api.method.service.CustomActionService"],"bindClassName":"net.ooder.dsm.aggregation.api.method.service.CustomActionService","caption":"回调动作","closeBtn":false,"dynDestory":false,"dynLoad":false,"entityClass":"net.ooder.dsm.aggregation.api.method.AggAPINavItem","groupName":"AggAPINavItem_CallBackActionConfig_dsm_agg_api_config_customactions_CustomActions","id":"loadNav_CallBackActionConfig","imageClass":"spafont spa-icon-action","initFold":false,"tagVar":{"name":"CallBackActionConfig"},"title":"回调动作"}],"title":"loadNav"}],"tabindex":0,"title":"AggMenuConfigTree"}])
                .setSelMode("single")
                .setSingleOpen(false)
                .setTabindex(0)
                .setVisibility("visible")
