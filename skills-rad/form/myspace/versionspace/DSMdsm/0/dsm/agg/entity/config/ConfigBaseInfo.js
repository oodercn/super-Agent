    ...
    Instance: {
        ...
        iniComponents: function() {
            ...
            var RELOAD = ood.create("ood.APICaller")
                ...
                .setQueryAsync(true)
                .setQueryMethod("POST")
                .setQueryURL("/dsm/agg/entity/config/ConfigBaseInfo")
                .setRequestDataSource([{"name":"ConfigBaseInfoMain","path":"","type":"FORM"},{"name":"PAGECTX","path":"","type":"FORM"}])
                .setRequestType("FORM")
                .setResponseCallback([])
                .setResponseDataTarget([{"name":"ConfigBaseInfoMain","path":"data","type":"FORM"},{"name":"PAGECTX","path":"data","type":"FORM"}])
                .setResponseType("JSON")
                .setSourceClassName("net.ooder.dsm.aggregation.config.entity.info.AggEntityNav")
                .setTabindex(3)
                .setTips("基础信息")
            ;
            append(RELOAD);
            ...
            var ConfigBaseInfo = ood.create("ood.UI.FormLayout")
                ...
                .setLayoutData({"cells":{"A1":{"cellName":"A1","style":{"textAlign":"center"},"value":"访问地址"},"A2":{"cellName":"A2","style":{"textAlign":"center"},"value":"名称"},"A3":{"cellName":"A3","style":{"textAlign":"center"},"value":"描述"},"A4":{"cellName":"A4","style":{"textAlign":"center"},"value":"类名"}},"colSetting":{"A":{"manualWidth":150},"B":{"manualWidth":150}},"cols":4,"merged":[{"col":1,"colspan":3,"removed":false,"row":0,"rowspan":1},{"col":1,"colspan":3,"removed":false,"row":1,"rowspan":1},{"col":1,"colspan":3,"removed":false,"row":2,"rowspan":1},{"col":1,"colspan":3,"removed":false,"row":3,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":0,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":0,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":0,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":0,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":0,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":3,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":3,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":3,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":3,"rowspan":1},{"col":1,"colspan":2,"removed":false,"row":3,"rowspan":1}],"rowSetting":{"1":{"manualHeight":35},"2":{"manualHeight":35},"3":{"manualHeight":50},"4":{"manualHeight":35}},"rows":4})
                .setLineSpacing(10)
                .setMode("write")
