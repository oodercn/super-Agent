...
ood.Class("ood.UI.Resizer", "ood.UI", {
    ...
    Static: {
        ...
        DataModel: {
            ...
            forceVisible: {
                ini: false,
                caption: ood.getResText("DataModel.forceVisible") || "强制可见"
            },
            forceMovable: {
                ini: '',
                caption: ood.getResText("DataModel.forceMovable") || "强制可移动"
            },

            singleDir: {
                ini: false,
                caption: ood.getResText("DataModel.singleDir") || "单方向"
            },
            vertical: {
                ini: true,
                caption: ood.getResText("DataModel.vertical") || "垂直调整"
            },
            horizontal: {
                ini: true,
                caption: ood.getResText("DataModel.horizontal") || "水平调整"
            },

            minHeight: {
                ini: 12,
                caption: ood.getResText("DataModel.minHeight") || "最小高度"
            },
            minWidth: {
                ini: 12,
                caption: ood.getResText("DataModel.minWidth") || "最小宽度"
            },
            maxHeight: {
                ini: 5000,
            ...
            maxWidth: {
                ini: 5000,
                caption: ood.getResText("DataModel.maxWidth") || "最大宽度"
            },

            handlerSize: {
                ini: ood.browser.contentBox ? 8 : 12,
                caption: ood.getResText("DataModel.handleSize") || "操作柄大小"
            },
            handlerOffset: {
                ini: ood.browser.contentBox ? 1 : 0,
                caption: ood.getResText("DataModel.handlerOffset") || "操作柄偏移"
            },
            readonly: {
                ini: false,
            ...
            leftConfigBtn: {
                ini: false,
                caption: ood.getResText("DataModel.leftConfigBtn") || "左侧配置按钮",
                action: function (v) {
            ...
            rightConfigBtn: {
                ini: false,
                caption: ood.getResText("DataModel.rightConfigBtn") || "右侧配置按钮",
                action: function (v) {
            ...
            rotatable: {
                ini: false,
                caption: ood.getResText("DataModel.rotatable") || "可旋转",
                action: function (v) {
...
//>>
            ...
            left: {
                ini: 100,
                caption: ood.getResText("DataModel.left") || "左侧位置"
            },
            top: {
                ini: 100,
                caption: ood.getResText("DataModel.top") || "顶部位置"
            },
            height: {
                ini: 100,
                caption: "高度"
