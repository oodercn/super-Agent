...
本文档提供了 Ooder AI Bridge 协议 v0.6.3 中 Skill 协议栈的参考实现代码，使用 Python + FastAPI 实现，展示了如何开发一个符合协议规范的 Skill 服务。
## 2. 项目结构
...
class SkillRepository:
    ...
    def get_all(self, skip: int = 0, limit: int = 100) -> List[Skill]:
        """获取所有 Skill"""
        return list(self.skills.values())[skip:skip+limit]
