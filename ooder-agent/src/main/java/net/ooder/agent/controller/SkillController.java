...
import net.ooder.agent.skill.registry.SkillRegistry;
import net.ooder.agent.skill.registry.SkillRegistry.SkillInfo;
import net.ooder.agent.dto.skill.SkillListDTO;
import net.ooder.agent.dto.skill.SkillStatusDTO;
