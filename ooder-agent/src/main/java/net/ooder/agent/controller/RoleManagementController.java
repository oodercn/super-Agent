...
import net.ooder.agent.dto.menu.MenuItemDTO;
import net.ooder.agent.dto.role.RoleDTO;
import net.ooder.agent.service.MenuRoleConfigService;
...
public class RoleManagementController {
    ...
    private RoleDTO convertToRoleDTO(net.ooder.agent.dto.menu.MenuConfigDTO.MenuRoleDTO dto) {
